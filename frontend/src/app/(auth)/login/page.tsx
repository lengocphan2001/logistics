      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[oklch(0.22_0.045_264)] text-white">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 w-full">
          ...
          <h2 className="text-4xl font-bold text-white leading-tight mb-4">
            Vận chuyển quốc tế
            <br />
            <span className="text-primary-foreground/90">đơn giản hơn.</span>
          </h2>
          <p className="text-white/75 text-lg leading-relaxed max-w-sm">
            Theo dõi đơn hàng, quản lý ví và nhận hàng tại Việt Nam — tất cả trên một nền tảng.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          <div className="flex items-center gap-2.5 mb-8 lg:hidden">
            ...
            <span className="font-bold text-foreground">Logistics</span>
          </div>

          <div className="mb-8">
            <h1 className="text-2xl font-bold text-foreground mb-1">Đăng nhập</h1>
            <p className="text-muted-foreground text-sm">Đăng nhập tài khoản khách hàng của bạn</p>
          </div>
